...
public class VersionHelper {
	...
	public static boolean init(boolean debug) {
		...
		try {
			...
			EntityIdList.init();
			ProfileHelper.setInstance((ProfileHelper)Class.forName("org.valdi.entities.management.profile.ProfileHelperUID").newInstance());
			Reflection.EntityHumanNonAbstract = Class.forName("org.valdi.entities.management.reflection.EntityHumanNonAbstract" + versionCode.replaceAll("[^0-9]*", ""));
